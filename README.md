...
The current local candidate is `0.1.0-rc.7`; rc.1, rc.2, rc.3, rc.4, rc.5, and rc.6 are
historical candidates. rc.7 builds only from exact Git content,
