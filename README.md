...
The current local candidate is `0.1.0-rc.9`; rc.1 through rc.8 are historical
candidates. rc.9 builds only from exact Git content,
...
M1 through M12.1 implementation work did not modify any live environment. M10 is the latest accepted milestone; M11 and M12.1 are local, implemented-but-not-accepted work. See `docs/ROADMAP.md` for the release gate.
