...
the M12 final routing gate, External Review #5, and Planner/manual acceptance
remain pending.
...
M1 through M12.3 implementation work did not modify any live environment. M10 is the latest accepted milestone; M11, M12.1, M12.2, and M12.3 are local, implemented-but-not-accepted work. See `docs/ROADMAP.md` for the release gate.
