...
Current public prerelease identity is RC31 (`0.1.0-rc.31`) on npm `next`: Pi-native live Mission
...
convergence, reliable Pi-native Escape / `/mission-cancel` cancellation, ADR-048
read-only timeout salvage, quiet startup, decoupled ownership leases, atomic
execution claims, and truthful health displays. `latest` remains `0.1.0-rc.17`. RC30 (`0.1.0-rc.30`)
is a prior public prerelease. RC29 (`0.1.0-rc.29`)
...
M1 through RC25 final-gate work did not modify any live environment. M10 remains the latest accepted development milestone; RC28 is a public prerelease, not a stable or production release. RC29 is a frozen unpublished verified candidate; RC30 is a local unpublished candidate. See `docs/ROADMAP.md` for the release state.
