...
| Development phase | M10 accepted; RC15 final external-review candidate after M12 routing/release repairs; M11 acceptance, external review, Planner, and publication gates pending |
...
| M12 final candidate | `0.1.0-rc.15` — local, not public; repair baseline `4416a85`; final candidate identity is generated by the detached verifier |
| M12 RC13 historical candidate | `0.1.0-rc.13` — local, superseded by RC15 after external-review repairs |
...
- **Status:** local candidate; final external review is pending. M10 remains the latest accepted milestone.
- **Repair baseline:** commit `4416a85` closes the review findings in release
  force-mode cleanup, bundle privacy, TAP skipped/todo accounting, trusted
  worker network/publication command policy, sensitive learned-NORMAL bypass,
  Mission/M7 target binding, corrupt Smart Routing fail-closed behavior,
  bounded/cancellable triage, malformed Routing Memory history, and Mission
  text normalization.
- **Local validation before detached packaging:** focused safety/routing/host/
  mission tests `69/69 PASS`; clean-checkout full suite `221/221 PASS` across
  13 suites; typecheck PASS. No live Pi configuration, provider account,
  credential, public tag, push, npm publication, or GitHub release was modified.
- **Release boundary:** RC15 will be accepted only from the detached release
  verifier and independent external review of the exact candidate. Planner or
  manual acceptance, publication, and production claims remain separate.
