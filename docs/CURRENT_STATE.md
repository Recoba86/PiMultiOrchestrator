...
| M12 final candidate | `0.1.0-rc.15` — local, not public; source-review baseline `3101fd7`; final candidate identity is generated by the detached verifier |
...
| M12 — Smart Mission Entry, Hybrid Routing & Routing Memory | IN PROGRESS; M12.1, M12.2, M12.3, final routing gate, and RC15 source review locally complete; not accepted or public |
