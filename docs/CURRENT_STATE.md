...
| Development phase | M10 remains the latest accepted development milestone; RC17 final external review and Planner/manual acceptance PASS locally; publication gates pending |
...
| M12 final candidate | `0.1.0-rc.17` — current local candidate; exact artifact and bundle identity are generated by the detached verifier |
| RC17 final Planner attempt | 2026-08-15 — PASS after the bounded reviewer-handoff repair; source-bound artifact remains local-only |
...
- **Terminal status:** `PMO_FINAL_PLANNER_ACCEPTANCE_PASS`. RC17 supersedes the
  ...
  remains local and unpublished. M10 remains the latest accepted development
  milestone.
