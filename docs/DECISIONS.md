...
- **Consequences:** `submit_agent_result`, verification, repair, and recommendation analyst flows remain structured protocols; their captured payloads are processed only after child execution. rc.2 is a rejected historical candidate, rc.3 remains a local candidate, and M11 remains implemented but not accepted pending independent review and Planner/manual gates.
