...
| Development manifest version | `0.1.0-rc.31` — RC31 Live Mission Progress, M7 Repair Convergence, cancellation, and ADR-048 timeout salvage; LOCAL / UNPUBLISHED / DOGFOOD; public RC30 remains unmodified |
| RC31 development line | ADR-048 timeout salvage, ADR-051 Pi-native live Mission progress, ADR-052 feedback-driven M7 repair convergence, ADR-053 cancellation; `0.1.0-rc.31`; live timeout-salvage Mission `mission-c0b9400a-b487-4dce-8e43-14bd7edfa7e5` COMPLETED with M7 pass; prior unpublished candidate SHA-256 `fb7aa4208470e731d84dae386f973ce5bc9c13cc2f506241a922f857e081a519` (source `0bc66b81b36e52a748c4fe2ef94b3c9465e197a7`) is stale relative to this salvage work; not tagged, npm-published, or a GitHub Release |
